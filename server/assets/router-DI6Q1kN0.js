...
const appCss = "/assets/styles-0lpx3V0K.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Tejas Patel — Associate Software Quality Engineer" },
      { name: "description", content: "Cinematic portfolio of an Associate Software Quality Engineer specializing in automation, API testing, and enterprise QA systems." },
      { name: "author", content: "Tejas Patel" },
      { property: "og:title", content: "Tejas Patel — Associate Software Quality Engineer" },
      { property: "og:description", content: "QA automation, API testing, and enterprise QA systems." },
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", className: "dark", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { className: "dark bg-background text-foreground antialiased", children: [
      children,
...
const $$splitComponentImporter = () => import("./index-DINJYnMq.js");
